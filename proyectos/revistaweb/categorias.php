...
<body class="bd_sis">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<h4><input type="checkbox" id="mismo" onChange="pagoOnChange(this)"> Agregar una Categoria</h4>
							<?php
								include("control/conect.php");
								$nombre="";
								$accion="control/categorias/insertarcategoria.php";
								$id="";
								...
								if(isset($_GET['id'])){
									...
									$id=$_GET['id'];
									$wsql="select * from categorias
									where idcategoria = '$id'";
									$result=mysql_query($wsql,$link);
									$row= mysql_fetch_array($result);
									
									$nombre=$row['nombre'];
									$accion="control/categorias/modificarcategoria.php";
									$mostrar="";
								...
								<div class="panel panel-default text-center">
									...
									<div class="panel-body modal-body">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="nombre" value="<?php echo $nombre ?>" id="nombre" placeholder="Nombre de la Categoria" required>
										</div>
									</div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<table class="table">
				    ...
				    <tbody>
				      <?php include('control/categorias/tablacategorias.php'); ?>
				    </tbody>
				  </table>
				  </div>
			</div>
