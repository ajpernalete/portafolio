...
<body class="bd_sis">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<h4><input type="checkbox" id="mismo" onChange="pagoOnChange(this)"> Agregar un Tipo de Usuario</h4>
							<?php
								include("control/conect.php");
								$nombre="";
								$idestatus="";
								$accion="control/tipodeusuarios/insertartipodeusuario.php";
								$id="";
								...
								if(isset($_GET['id'])){
									...
									$id=$_GET['id'];
									$wsql="select * from tipodeusuario
									...
									$nombre=$row['nombre'];
									$accion="control/tipodeusuarios/modificartipodeusuario.php";
									$mostrar="";
							...
							<input type="hidden" name="id" value="<?php echo $id ?>">
								<div class="panel panel-default text-center">
									<div class="panel-heading">
										<div class="panel-title text-center"><h4>TIPO DE USUARIOS</h4></div>
									</div>
									<div class="panel-body modal-body">
										<div class="form-group">
											<label for="idestatus">Estatus de Tipo de Usuarios</label>
											<select name="idestatus" class="form-control" id="sel1" required>
												<?php include("control/estatusselect.php"); ?>
											</select>
										</div>
										<div class="form-group">
											<label for="nombre">Tipo de Usuario</label>
											<input type="text" class="form-control" name="nombre" value="<?php echo $nombre ?>" id="nombre" placeholder="Tipo de Usuario" required>
										</div>
									</div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<table class="table">
				    ...
				    <tbody>
				      <?php include('control/tipodeusuarios/tablatipodeusuarios.php'); ?>
				    </tbody>
				  </table>
				  </div>
			</div>
