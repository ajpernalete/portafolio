...
<div class="col-md-10 col-md-offset-1">
            	...
            	<form  name="form1"  class="form-horizontal" role="form" method="post" action="gsubirfoto.php" enctype="multipart/form-data">
                    ...
                    <div class="panel  panel-default">
                        ...
                        <div class="panel-body">
                   			...
                   			<div class="form-group">
                            <label for="idaseguradora" class="col-xs-3 control-label">Foto</label>
                            	<div class="col-xs-9">
                                	<input name="foto" type="file" class="form-control" required>
                            	</div>
                        	</div>
                            <div class="form-group">
                            <label for="idaseguradora" class="col-xs-3 control-label">Pie de Foto</label>
                            	<div class="col-xs-9">
    ...
    <thead class="well">
      <tr>
        ...
        <td width="84%" class="text-center">Pie de Foto</td>
     ...
     <?php 
	  ...
	  $wsqli="select * from rnoticiasfotos where idnoticia='$id' order by idrnoticiasfoto desc";
	  $result = $linki->query($wsqli);
		if($linki->errno) die($linki->error);
		while($row = $result->fetch_array()){
			$idr=$row['idrnoticiasfoto'];

			$nombre=str_replace('"',' ',$row['piedefoto']); 

	 ?>
      <tr>
        <td><img src="../../imgnoticias/fotop<?php echo $idr; ?>.jpg" width="80"></td>
        <td><?php echo $row['piedefoto'] ?></td>
        <td> 
    	<a class="eliminar_dato" title="<?php echo 'Seguro que desea eliminar este registro:<br><center><h4>'.$nombre.'</h4><center>' ?>" href="eliminarfoto.php?modo=e&id=<?php echo $id; ?>&idr=<?php echo $idr; ?>"><button type="button" class="btn btn-danger btn-xs">Eliminar</button></a>
