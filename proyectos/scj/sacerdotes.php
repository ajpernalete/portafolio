			...
			<div class="col-md-8 col-md-offset-2">
							...
							<?php 
								include("control/conect.php");
									...
									$accion="control/sacerdotes/insertarsacerdotes.php";
									$idsacerdote="";
									$nombre="";
									$apellido="";
								...
								if(isset($_GET['id'])){
									$idsacerdote=$_GET['id'];
									$wsql="select * from sacerdotes
									where idsacerdote = '$idsacerdote'";
									$result=mysql_query($wsql,$link);
									$row= mysql_fetch_array($result);
									
									$nombre=$row['nombre'];
									$apellido=$row['apellido'];
									$accion="control/sacerdotes/modificarsacerdotes.php";
							...
							<input type="hidden" name="id" value="<?php echo $idsacerdote ?>">
								<div class="panel panel-default text-center">
									...
									<div class="panel-body modal-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="apellido" value="<?php echo $apellido ?>" id="apellido" placeholder="Apellido" required>
										</div
									</div>
		...
		<div class="row">
			...
			<div class="table-responsive">
				<table class="table">
				    ...
				    <tbody>
				    	<?php include('control/sacerdotes/tablasacerdotes.php') ?>
				    </tbody>
				  </table>
			</div>
			</div>
